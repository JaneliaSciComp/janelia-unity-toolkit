...
namespace Janelia
{
    ...
    public static class PlaybackHandlerRuntimeInitializeOnLoad
    {
        ...
        private static void OnRuntimeMethodLoad()
        {
            ...
            {
                Logger.enable = args.Contains("-logDuringPlayback");
        ...
        public bool Update(ref Transformation currentTransformation, Transform transform)
        {
            ...
            if (_playbackRequested)
            {
                if (SplashScreen.isFinished)
                {
                    ...
                    // Exclude items with keys containing "mesh" (e.g., those generated by LogUtilities.LogAllMeshes())
                    _playbackLogEntries = Logger.Read<Transformation>(_playbackLogFile, exclude:"mesh");

                    // Exclude items that have empty transform values.
